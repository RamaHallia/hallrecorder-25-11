    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-coral-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-cocoa-900 mb-2">Connexion</h1>
          <p className="text-cocoa-600">Accédez à votre compte</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border-2 border-orange-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <Link
                to="/forgot-password"
                className="text-sm text-coral-600 hover:text-coral-700 font-semibold transition-colors"
              >
                Mot de passe oublié ?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-cocoa-600 text-sm">
              ...
              <Link to="/signup" className="text-coral-600 hover:text-coral-700 font-semibold transition-colors">
                Créer un compte
              </Link>
            </p>
          </div>
